from sqlalchemy import Column, String, DateTime, JSON, Enum, ForeignKey, Text, Integer
...
class ChatSessionDB(Base):
    ...
    # Relationships
    turns = relationship("ChatTurnDB", back_populates="session", cascade="all, delete-orphan")
