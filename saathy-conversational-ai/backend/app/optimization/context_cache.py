...
class ContextCache:
    ...
    async def get_cached_query_result(self, query: str, user_id: str, 
                                    time_window: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def cache_query_result(self, query: str, user_id: str, result: Dict[str, Any],
    ...
    async def get_cached_context(self, information_needs: Dict[str, Any], 
    ...
    async def cache_context(self, information_needs: Dict[str, Any], 
    ...
    def _generate_query_cache_key(self, query: str, user_id: str, 
                                time_window: Optional[Dict[str, Any]]) -> str:
    ...
    def _generate_context_cache_key(self, information_needs: Dict[str, Any], 
                                  user_id: str) -> str:
        ...
        key_components = {
            ...
            "entities": sorted(str(v) for v in information_needs.get("entities", {}).values()),
            "platforms": sorted(information_needs.get("platforms", [])),
            "time_reference": information_needs.get("time_range", {}).get("reference", "")
        }
    ...
    def _is_cache_entry_valid(self, cache_entry: Dict[str, Any], 
                            current_time_window: Optional[Dict[str, Any]]) -> bool:
        """
        ...
        if current_time_window and cache_entry.get("time_window"):
            cached_window = cache_entry["time_window"]
    ...
    def _find_similar_context(self, information_needs: Dict[str, Any], 
                            user_id: str) -> Optional[str]:
        """
