...
from src.saathy.chunking import (
    ChunkingProcessor, ChunkingConfig, ContentTypeDetector,
    ChunkAnalyzer, ChunkVisualizer, ChunkQualityMetrics,
...
class TestChunkingProcessor:
    ...
    def test_automatic_strategy_selection(self):
        ...
        assert all(chunk.metadata.content_type == ContentType.DOCUMENT for chunk in chunks)
