...
class TimingOptimizer:
    ...
    async def is_good_time_for_batch(self, user_id: str, user_prefs: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            for period, (start, end) in self.optimal_hours.items():
    ...
    async def get_next_batch_time(self, user_prefs: Dict[str, Any]) -> datetime:
        ...
        try:
            ...
            if not next_time:
                ...
                next_time = tomorrow.replace(hour=first_optimal_hour, minute=0, second=0, microsecond=0)
    ...
    async def learn_user_patterns(self, user_id: str, interaction_history: List[Dict[str, Any]]):
