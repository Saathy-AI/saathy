    ...
    def _split_into_sections(self, content: str) -> List[Dict[str, Any]]:
        ...
        for i, line in enumerate(lines):
            ...
            if is_header and current_section["content"]:
                # End current section
                current_section["end"] = current_section["start"] + len(
...
class CodeChunking(ChunkingStrategy):
    ...
    def _extract_functions(self, content: str, language: str) -> List[Dict[str, Any]]:
        ...
        for i, match in enumerate(matches):
            ...
            functions.append(
                {"name": func_name, "content": func_content, "start": start, "end": end}
            )
...
class ChunkingPipeline:
    ...
    def validate_chunks(
        ...
        coverage_ratio = (
            total_chunk_length / len(original_content) if original_content else 0
        )
