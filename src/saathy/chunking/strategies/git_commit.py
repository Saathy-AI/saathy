...
class GitCommitChunker(BaseChunkingStrategy):
    ...
    def _chunk_message(self, message: str, metadata: Optional[ChunkMetadata] = None) -> list[Chunk]:
    ...
    def _chunk_diff(self, diff: str, metadata: Optional[ChunkMetadata] = None) -> list[Chunk]:
