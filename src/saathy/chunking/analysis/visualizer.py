...
class ChunkVisualizer:
    ...
    def _check_matplotlib(self) -> bool:
        ...
        try:
            importlib.util.find_spec("matplotlib.pyplot")
    ...
    def plot_chunk_size_distribution(
        self, chunks: list[Chunk], save_path: Optional[str] = None
    ) -> None:
        ...
        try:
            ...
            # Histogram
            ax1.hist(
                chunk_sizes, bins=20, alpha=0.7, color="skyblue", edgecolor="black"
            )
            ...
            # Box plot
            ax2.boxplot(
                chunk_sizes, patch_artist=True, boxprops={"facecolor": "lightgreen"}
            )
    ...
    def plot_chunk_overlap_analysis(
        self, chunks: list[Chunk], save_path: Optional[str] = None
    ) -> None:
        ...
        try:
            ...
            ax1.plot(
                chunk_indices, next_overlaps, "s-", label="Overlap with Next", alpha=0.7
            )
    ...
    def plot_chunk_type_distribution(
        self, chunks: list[Chunk], save_path: Optional[str] = None
    ) -> None:
    ...
    def visualize_chunk_boundaries(
        ...
        try:
            ...
            chunk_boundaries = [
                (chunk.start_index, chunk.end_index) for chunk in chunks
            ]
            ...
            ax.plot(
                [0, content_length], [0, 0], "k-", linewidth=2, label="Original Content"
            )
